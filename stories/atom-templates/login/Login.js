...
import { createInput } from "../../atom-components/forms/input/Input";
import { createTextElement } from "../../atom-components/textElement/TextElement";
import "./login.css";
//import absherLogo from "../../../src/images/absher.svg";
const absherLogo = `<svg xmlns="http://www.w3.org/2000/svg" class="absher-logo" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" style="enable-background:new 0 0 411.5 316.4;" xml:space="preserve" viewBox="136.39 67.25 131.81 196.45">
<style type="text/css">
.st0 {
    fill-rule: evenodd;
    clip-rule: evenodd;
...
export const createLogin = ({
  ...
  loginWrapper.innerHTML = absherLogo;
  ...
  loginWrapper.appendChild(
    createButton({ label: primaryBtnLbl, block: true, size: "lg" })
  );
  loginWrapper.appendChild(
    createButton({
